// Using Unsplash plant images (stable CDN links)
export const categories = [
  {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1485955900006-10f4d324d411?w=900&auto=format&fit=crop',
    plants: [
      {
        id: 'snake-plant',
        name: 'Snake Plant',
        ...
        tags: ['Air Purifier'],
        image:
          'https://images.unsplash.com/photo-1593691509543-c55fb32d8de5?w=500&auto=format&fit=crop',
        bg: '#f5f5ef',
      },
      {
        id: 'golden-pothos',
        ...
        tags: ['Air Purifier'],
        image:
          'https://images.unsplash.com/photo-1572688484438-313a6e50c333?w=500&auto=format&fit=crop',
        bg: '#fdf6ee',
      },
      {
        id: 'zz-plant',
        ...
        tags: ['Air Purifier'],
        image:
          'https://images.unsplash.com/photo-1632207691143-643e2a9a9361?w=500&auto=format&fit=crop',
        bg: '#fdf6ee',
      },
      {
        id: 'spider-plant',
        ...
        image:
          'https://images.unsplash.com/photo-1597305877032-0668b3c6413a?w=500&auto=format&fit=crop',
        bg: '#f5f5ef',
      },
    ],
  },
  {
    ...
    watering: 'Every 1–2 weeks',
    heroImage:
      'https://images.unsplash.com/photo-1463936575829-25148e1db1b8?w=900&auto=format&fit=crop',
    plants: [
      {
        id: 'peace-lily',
        name: 'Peace Lily',
        ...
        tags: ['Air Purifier'],
        image:
          'https://images.unsplash.com/photo-1593482892290-f54927ae1bb6?w=500&auto=format&fit=crop',
        bg: '#f5f5ef',
      },
      {
        id: 'boston-fern',
        ...
        tags: ['Pet-Safe', 'Air Purifier'],
        image:
          'https://images.unsplash.com/photo-1508022713622-df2d8fb7b4cd?w=500&auto=format&fit=crop',
        bg: '#fdf6ee',
      },
      {
        id: 'rubber-plant',
        ...
        tags: ['Air Purifier'],
        image:
          'https://images.unsplash.com/photo-1604762524889-3e2fcc145683?w=500&auto=format&fit=crop',
        bg: '#fdf6ee',
      },
      {
        id: 'areca-palm',
  ...
  },
  {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1586348943529-beaae6c28db9?w=900&auto=format&fit=crop',
    plants: [
      {
        id: 'aloe-vera',
        name: 'Aloe Vera',
        ...
        tags: ['Air Purifier'],
        image:
          'https://images.unsplash.com/photo-1567593810070-7a3d471af022?w=500&auto=format&fit=crop',
        bg: '#f5f5ef',
      },
      {
        id: 'jade-plant',
        ...
        tags: [],
        image:
          'https://images.unsplash.com/photo-1459156212016-c812468e2115?w=500&auto=format&fit=crop',
        bg: '#fdf6ee',
      },
      {
        id: 'cast-iron-plant',
        ...
        tags: ['Pet-Safe'],
        image:
          'https://images.unsplash.com/photo-1570281738459-8c0faf4e7b8b?w=500&auto=format&fit=crop',
        bg: '#fdf6ee',
      },
      {
        id: 'ponytail-palm',
        ...
        tags: ['Pet-Safe'],
        image:
          'https://images.unsplash.com/photo-1509423350716-97f9360b4e09?w=500&auto=format&fit=crop',
        bg: '#f5f5ef',
      },
    ],
  },
  {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?w=900&auto=format&fit=crop',
    plants: [
      {
        id: 'lucky-bamboo',
        name: 'Lucky Bamboo',
      ...
      },
      {
        ...
        tags: ['Pet-Safe', 'Air Purifier'],
        image:
          'https://images.unsplash.com/photo-1555955255-a1c35b5d5bff?w=500&auto=format&fit=crop',
        bg: '#f5f5ef',
      },
      {
        id: 'nerve-plant',
        ...
        tags: ['Pet-Safe'],
        image:
          'https://images.unsplash.com/photo-1590516513012-fb14c8e5d67a?w=500&auto=format&fit=crop',
        bg: '#fdf6ee',
      },
      {
        ...
        tags: ['Air Purifier'],
        image:
          'https://images.unsplash.com/photo-1586847630502-0e53a6f48df7?w=500&auto=format&fit=crop',
        bg: '#f5f5ef',
      },
    ],
  },
  {
    ...
    watering: 'Every 1–2 weeks',
    heroImage:
      'https://images.unsplash.com/photo-1601758124510-52d02ddb7cbd?w=900&auto=format&fit=crop',
    plants: [
      {
        ...
        tags: ['Pet-Safe'],
        image:
          'https://images.unsplash.com/photo-1600411833196-7c1f6b1a8b90?w=500&auto=format&fit=crop',
        bg: '#f5f5ef',
      },
      {
        id: 'prayer-plant',
      ...
      },
      {
        ...
        tags: ['Pet-Safe'],
        image:
          'https://images.unsplash.com/photo-1612520699012-8c76e9e6b50f?w=500&auto=format&fit=crop',
        bg: '#fdf6ee',
      },
      {
        id: 'hoya-carnosa',
