...
import heroBg from '../assets/1B.jpg';
import A from '../assets/AA.jpg';
import B from '../assets/AB.jpg';
import D from '../assets/AD.jpg';
import C from '../assets/AC.jpg';
import E from '../assets/AE.jpg';
...
const team = [
  { name: 'Emma Greenfield', role: 'Founder & CEO', bio: 'Former botanist turned entrepreneur. Emma spent 12 years studying tropical plants across Southeast Asia before founding GreenNest. She believes everyone deserves access to the joy and wellness benefits of indoor plants.', img: A },
  { name: 'Marcus Chen', role: 'Head Grower', bio: 'With over 20 years of horticulture experience, Marcus oversees our greenhouse operations. He personally inspects every plant before it ships, ensuring only the healthiest specimens reach your doorstep.', img: B },
  { name: 'Sophia Rivera', role: 'Customer Experience Lead', bio: 'Sophia is a passionate plant collector with over 80 plants in her own home. She leads our customer support team and creates the care guides that help our community keep their plants thriving.', img: C },
  { name: 'David Park', role: 'Sustainability Director', bio: 'David leads our mission to make GreenNest the most eco-friendly plant company. From biodegradable packaging to carbon-neutral shipping, he ensures every decision we make honors our commitment to the planet.', img: D },
];
